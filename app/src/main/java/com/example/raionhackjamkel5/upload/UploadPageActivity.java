                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Task<Uri> downloadUrl = taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            ...
                                            database.child("Users").child(userId).child("ProdukSaya").push().setValue(new KatalogModel(
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(UploadPageActivity.this, "Data produk berhasil ditambahkan ke produk Anda", Toast.LENGTH_SHORT).show();
                                                }
                                            });

                                            database.child("SemuaProduk").push().setValue(new KatalogModel(
                                                    getNamaProduk, getNamaPenjual[0], getNoWhatsapp[0], getHargaBeli, getHargaJual, getLokasiProduk, getDeskripsiProduk, getKategoriProduk, getFotoProduk
                                            )).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
